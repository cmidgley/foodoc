...
var options = exports.options = extend({
    ...
    defaultFilterInherited: true,
    defaultFilterPublic: true,
    defaultFilterProtected: false,
    defaultFilterPrivate: false,
...
var generateStaticFiles = exports.generateStaticFiles = function(){
	...
	if (options.pageLogo){
		...
		if (stats.isFile()){
			...
			options.pageLogo = 'img/'+path.basename(options.pageLogo);
		}
	}
